...
// ID de la chaine
$channelId="UCK9JfK05_0GM3uk1OpREnTQ";
...
foreach($data->items as $row){
    ...
    <iframe width='760' style='aspect-ratio:16/9;margin:auto;display:block;border-color:blue;margin-top:2%;margin-bottom:2%;' src='https://www.youtube.com/embed/$videoId' frameborder='40' allowfullscreen></iframe>
        </div>
        ";
}
?>
